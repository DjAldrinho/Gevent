        ...
        <form class="form-horizontal" action="{{route('update')}}" method="POST">
            <div class="form-group">
                ...
                <div class="col-sm-10 @if($errors->has('email')) has-error @endif">
                    <input type="email" class="form-control" id="inputEmail3" placeholder="Email" required name="email" value="{{$usuario->email}}"
                    />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 @if($errors->has('nombres')) has-error @endif">
                    <input type="text" class="form-control" id="txtNombres" placeholder="Nombres" required name="nombres" value="{{$usuario->nombres}}"
                    />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 @if($errors->has('apellidos')) has-error @endif">
                    <input type="text" class="form-control" id="txtApellidos" placeholder="Apellidos" required name="apellidos" value="{{$usuario->apellidos}}"
                    />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 @if($errors->has('fecha_nacimiento')) has-error @endif">
                    <input type="text" class="form-control" id="dateFechaNacimiento" placeholder="Fecha de Nacimiento (Ejemplo: 24/12/1995)"
                        required value="{{$usuario->fecha_nacimiento->format('d/m/Y')}}" name="fecha_nacimiento" />
